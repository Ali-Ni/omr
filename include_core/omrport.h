...
typedef struct OMRPortLibrary {
	...
	/** see @ref omrsysinfo.c::omrsysinfo_set_number_active_CPUs "omrsysinfo_set_number_active_CPUs"*/
	void (*sysinfo_set_number_active_CPUs)(struct OMRPortLibrary *portLibrary, uintptr_t number) ;
...
#define omrsysinfo_set_number_active_CPUs(param1) privateOmrPortLibrary->sysinfo_set_number_active_CPUs(privateOmrPortLibrary,(param1))
